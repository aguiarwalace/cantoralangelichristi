const datosLiturgicos = {
    "Ciclo A": [
        ...
        { id: "a_pascua", nombre: "Domingo de Pascua", cantos: [1,2,3,4,5] },

        // TIEMPO PASCUAL
        { id: "a_pascua_2", nombre: "2º Domingo de Pascua", cantos: [1,2,3,4,5] },
        { id: "a_pascua_3", nombre: "3º Domingo de Pascua", cantos: [1,2,3,4,5] },
        { id: "a_pascua_4", nombre: "4º Domingo de Pascua", cantos: [1,2,3,4,5] },
        { id: "a_pascua_5", nombre: "5º Domingo de Pascua", cantos: [1,2,3,4,5] },
        { id: "a_pascua_6", nombre: "6º Domingo de Pascua", cantos: [1,2,3,4,5] },
