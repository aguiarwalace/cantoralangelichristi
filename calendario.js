const datosLiturgicos = {
    ...
    "Solemnidades": [
     ...
     "Eventos": [
        ...
        { id: "vig_pentecostes_hsanta", nombre: "Vigilia de Pentecostés - Motul - H.Santa (23/05/2026)", cantos: [1,2,3,4,5] },
        { id: "vig_pentecostes_anima", nombre: "Vigilia de Pentecostés - Motul - Animación (23/05/2026)", cantos: [1,2,3,4,5] },
     ],
};
